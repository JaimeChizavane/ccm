...
// swiper plugin Logo Section active.	
    var swiper = new window.Swiper('.swiper-container-two', {
      slidesPerView: 5,
...
// swiper plugin Testimonial Two active.	
    var swiper = new window.Swiper('.testimonial-parents', {
      slidesPerView: 3,
      paginationClickable: false,
      spaceBetween: 30,
      autoplay: 3000,
...
// swiper plugin Testimonial Two active.	
    var swiper = new window.Swiper('.testimonial-parents-sidebar', {
      slidesPerView: 1,
      paginationClickable: false,
      spaceBetween: 100,
      autoplay: 3000,
